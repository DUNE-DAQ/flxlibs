...
CardControllerWrapper::CardControllerWrapper(uint32_t device_id)
  : m_device_id(device_id)
{
  TLOG_DEBUG(TLVL_ENTER_EXIT_METHODS) << "CardControllerWrapper constructor called. Open card " << m_device_id;
